...
ActiveRecord::Schema.define(version: 20160612160449) do

  create_table "airdata", force: :cascade do |t|
    ...
    t.string   "peso_ui",                  limit: 255
    t.string   "peso_ue",                  limit: 255
    ...
    t.string   "consumo_refrigeracion",    limit: 255
    t.string   "consumo_calefaccion",      limit: 255
